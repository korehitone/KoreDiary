package com.syntxr.korediary.presentation.home.draft
...
import com.syntxr.korediary.presentation.home.post.Menu
...
fun DraftContent(
    ...
    publish: (uuid: String, published: Boolean) -> Unit,
    deleteAll: () -> Unit,
) {
    ...
    AnimatedVisibility(visible = isPublish) {
        SaveDialog(
